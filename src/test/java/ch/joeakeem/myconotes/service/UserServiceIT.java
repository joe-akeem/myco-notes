...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the ch.joeakeem.myconotes.repository.search test package.
     *
     * @see ch.joeakeem.myconotes.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
