package ch.joeakeem.myconotes.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ch.joeakeem.myconotes.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ch.joeakeem.myconotes.repository.UserRepository.USERS_BY_EMAIL_CACHE);
