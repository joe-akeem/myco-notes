...
describe('Observation Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'observation', component: ObservationComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.observations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to observationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getObservationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getObservationIdentifier).toHaveBeenCalledWith(entity);
