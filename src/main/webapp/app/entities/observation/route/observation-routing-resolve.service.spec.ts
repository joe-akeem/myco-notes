...
describe('Observation routing resolve service', () => {
  ...
  let resultObservation: IObservation | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultObservation).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IObservation>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
