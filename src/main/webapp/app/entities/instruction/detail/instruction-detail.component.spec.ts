...
describe('Instruction Management Detail Component', () => {
  let comp: InstructionDetailComponent;
      ...
      providers: [
        {
          ...
          useValue: { data: of({ instruction: { id: 123 } }) },
        },
      ],
    })
  ...
  describe('OnInit', () => {
    it('Should load instruction on init', () => {
      // WHEN
      comp.ngOnInit();

      // THEN
      expect(comp.instruction).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
