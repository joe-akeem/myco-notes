...
describe('Species Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'species', component: SpeciesComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to speciesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSpeciesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSpeciesIdentifier).toHaveBeenCalledWith(entity);
