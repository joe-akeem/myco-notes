...
describe('Experiment Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'experiment', component: ExperimentComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to experimentService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getExperimentIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getExperimentIdentifier).toHaveBeenCalledWith(entity);
